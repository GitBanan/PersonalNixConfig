{
  ...
  users.users."jee".openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPE8DBiLGdkGVsb/xGphb4eRxNnTknRYdeMBh071n/27 jee@vostro"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIN0PBV32uKIEtuTbj1COcTdPRSNV09mu/cCKMpklVt3 jee@desktop"
  ];
}
